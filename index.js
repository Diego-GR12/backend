...
async function generarYGuardarImagen(promptTexto, modeloId = "Salesforce/blip-image-captioning-large") {
  ...
  const modeloSeleccionado = modeloId || "Salesforce/blip-image-captioning-large"; // Asegura un default
